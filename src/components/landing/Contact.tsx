...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(links, { x: -60, opacity: 0 }, {
  ...
  return (
    <section ref={sectionRef} id="kontakt" className="py-20 md:py-32 px-4">
      <div className="container">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            <a
              href="tel:+38268593203"
              className="contact-link glass-card flex items-center gap-4 p-4 md:p-6 hover:translate-x-2 transition-all duration-300"
            >
              <div className="w-12 h-12 flex items-center justify-center bg-primary/10 rounded-xl text-primary">
                <Phone className="w-5 h-5" />
              </div>
              <div>
                <span className="block text-xs text-muted-foreground uppercase tracking-wider">{t("contact.phone")}</span>
            ...
            <a
              ...
              className="contact-link glass-card flex items-center gap-4 p-4 md:p-6 hover:translate-x-2 transition-all duration-300"
            >
              <div className="w-12 h-12 flex items-center justify-center bg-[#25D366]/15 rounded-xl text-[#25D366]">
            ...
            >
              <div
                className="w-12 h-12 flex items-center justify-center rounded-xl text-[#e1306c]"
                style={{ background: "linear-gradient(135deg, rgba(240, 148, 51, 0.15), rgba(188, 24, 136, 0.15))" }}
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <span className="block text-xs text-muted-foreground uppercase tracking-wider">Instagram</span>
                <span className="font-medium">@montequadtourkolasin</span>
              </div>
            </a>
          </div>
        </div>
