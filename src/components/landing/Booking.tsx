...
const Booking = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const card = sectionRef.current!.querySelector(".booking-card");
      if (card) {
  ...
  return (
    <section ref={sectionRef} id="booking" className="py-20 md:py-32 px-4">
      <div className="container">
        <div className="booking-card glass-card p-8 md:p-12 lg:p-16">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Button
                asChild
                size="lg"
                className="btn-glow cta-shimmer bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow hover:shadow-[0_0_50px_hsl(168_100%_48%_/_0.4)] transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] rounded-xl py-6 text-base font-semibold"
              >
